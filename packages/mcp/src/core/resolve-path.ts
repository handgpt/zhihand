 ...
 */
export function resolveExecutable(name: string, fallbackPaths: string[]): string {
...
export function resolveGemini(): string {
...
export function resolveClaude(): string {
  ...
  if (process.platform === "darwin") {
    fallbacks.push(
      path.join(home, "Library/Application Support/Claude/claude-code/*/claude.app/Contents/MacOS/claude"),
