import { registry, type DeviceState } from "../core/registry.ts";

export type ResolveResult = { state: DeviceState } | { error: string };

export function resolveTargetDevice(deviceId: string | undefined): ResolveResult {
