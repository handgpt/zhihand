...
| `zhihandd` | `0.10.x` | Reference HTTP/SSE service |
| OpenClaw adapter | `0.10.x` | Published as `@zhihand/openclaw` |
...
- should stay on the same public core minor line (`0.10.x`)
