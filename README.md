...
Current public core version: `0.9.0`
...
Run `/zhihand update check` to inspect the latest published version, or `/zhihand update` to install it and then reload OpenClaw.
